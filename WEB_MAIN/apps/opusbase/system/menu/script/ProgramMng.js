           ...
           case "REMOVE":
                ...
                for(var i=1; i < rowLen; i++){
					...
					if(sheetObj.GetCellValue(i, 'cur_cnt')>0){
                			//Program +' "'+sheetObj.CellValue(i, 'pgm_nm')+'] is registrered to authorization previously.\r\n\r\nPlease revoke its authority!
    ...
    switch(sheetNo) {
         case 1:      //IBSheet1 init
           ...
           var cols = [ {Type:"DelCheck",  Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"curSelec" },
                  ...
                  {Type:"Text",      Hidden:0,  Width:250,  Align:"Left",    ColMerge:0,   SaveName:"pgm_nm",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                  //{Type:"CheckBox",  Hidden:0,  Width:80,  Align:"Left",    ColMerge:0,   SaveName:"mlt_tab",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                  ...
                  {Type:"Text",      Hidden:0,  Width:100,   Align:"Center",  ColMerge:0,   SaveName:"srt_seq",   KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
