...
<%@ page pageEncoding="UTF-8"%>
    ...
    <script type="text/javascript" src="./apps/opusbase/system/menu/script/ProgramMng.js"></script>
	<script>
...
<form method="post" name="frm1" onSubmit="return false;">
	...
	<div class="page_title_area clear">
	   ...
	   --><button type="button" class="btn_normal" onClick="doWork('EXCEL')" style="cursor:hand;" name="btn_DownExcel"><bean:message key="Excel"/></button></div>
	   <!-- btn_div -->
	   <div class="location">
		   <span><%=LEV1_NM%></span> &gt;
		   <span><%=LEV2_NM%></span> &gt;
	...
	<div class="layout_wrap">
	    <div class="layout_flex_fixed" style="width:350px;float:left!important">
	        ...
	        <div class="opus_design_grid">
	            <iframe id='dispFr' src='./ProgramMngSub.clt?workLevel=4' marginwidth='0' marginheight='0' topmargin='0' width="100%" height="100%" scrolling='yes' frameborder='0' style="margin-top:0px;width:350px; height:600px;top:0px;border:none;display:block;border:1 solid #d2d9e1"></iframe>
	        </div>
	        <!-- opus_design_grid(E) -->
	    </div>
