...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/sei/bmd/arrivalnotice/script/SEI_DOC_1081.js"></script>
				...
				<table>
					...
					<tbody>
	                     ...
	                     <tr>
	                        ...
	                        <td>
	                            <textarea name="special_instructions" class="search_form" style="width:325px;height:80px"></textarea>
	                        </td>
	                    </tr>
	                    <tr>
