...
<logic:empty name="com.clt.framework.core.comm.EXCEPTION_OBJECT      ">
	...
	<logic:notEmpty name="EventResponse" property="objVal">
		...
		<DATA>
			<sel_cls_no><bean:write name="obj" property="sel_cls_no"/></sel_cls_no>
			<su_yn><bean:write name="obj" property="su_yn"/></su_yn>
			<su_value><bean:write name="obj" property="su_value"/></su_value>
		</DATA>
	</logic:notEmpty>
</logic:empty>
<%-- 오류발생 --%>
