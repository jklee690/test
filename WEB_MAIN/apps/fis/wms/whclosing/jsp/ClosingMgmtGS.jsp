...
<logic:empty name="com.clt.framework.core.comm.EXCEPTION_OBJECT      ">
	...
	<logic:notEmpty name="valMap" property="MgmtInfo">
		<DATA>
			<bean:define id="MgmtInfo" name="valMap" property="MgmtInfo"/>
				<cls_no><bean:write name="MgmtInfo" property="cls_no"/></cls_no>
				<so_no><bean:write name="MgmtInfo" property="so_no"/></so_no>
		</DATA>
	</logic:notEmpty>
	|$$|
	<logic:empty name="valMap" property="MgmtDtlObj">
		<SHEET>
			<DATA TOTAL="0"></DATA>
		</SHEET>	
	</logic:empty>
	...
	<logic:notEmpty name="valMap" property="MgmtDtlObj">
		<bean:define id="rowSet1" name="valMap" property="MgmtDtlObj"/>
		<SHEET>
			<DATA TOTAL="<bean:write name="valMap" property="MgmtDtlObjSize"/>">
