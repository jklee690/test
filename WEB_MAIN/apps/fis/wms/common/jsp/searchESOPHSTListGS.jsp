				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="tro_no"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="tro_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="sb_clss_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="tro_add_frt_seq"/>]]></TD>
							<TD></TD>
			            </tr>
					</logic:iterate>
					</DATA>
