...
<logic:empty name="com.clt.framework.core.comm.EXCEPTION_OBJECT      ">
	<logic:notEmpty name="EventResponse" property="mapVal">
		...
		<COMMON>
			...
			<logic:empty name="mapVal" property="WHInbkFileList">
				<SHEET5>
					<SHEET>
						<DATA TOTAL="0"></DATA>
					</SHEET>
			...
			<logic:notEmpty name="mapVal" property="WHInbkFileList">
				
				<bean:define id="rowSet" name="mapVal" property="WHInbkFileList"/>
				
				<SHEET5>
					<SHEET>
						<DATA TOTAL="<bean:write name="mapVal" property="WHInbkFileListSize"/>">
