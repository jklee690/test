				...
				<bean:define id="rowSet" name="EventResponse" property="listVal"/>
					<DATA TOTAL="<bean:write name="EventResponse" property="listValCnt"/>">
						<logic:iterate id="row" name="rowSet">
                            ...
                            <consol_no><![CDATA[<bean:write name="row" property="consol_no"/>]]></consol_no>
							<lp_sts_cd><![CDATA[<bean:write name="row" property="lp_sts_cd"/>]]></lp_sts_cd>
                            ...
                            <eq_tpsz_cd><![CDATA[<bean:write name="row" property="eq_tpsz_cd"/>]]></eq_tpsz_cd>
							<eq_no><![CDATA[<bean:write name="row" property="eq_no"/>]]></eq_no>
                            <seal_no><![CDATA[<bean:write name="row" property="seal_no"/>]]></seal_no>
                            <gate_in_hm><![CDATA[<bean:write name="row" property="gate_in_hm"/>]]></gate_in_hm>
                            <gate_out_hm><![CDATA[<bean:write name="row" property="gate_out_hm"/>]]></gate_out_hm>
