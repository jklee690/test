				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>							
							...
							<TD><![CDATA[<bean:write name="row" property="yrmon"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="tgt_amt"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="ofc_incnt_pct"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="opr_incnt_pct"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="acctg_incnt_pct"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="use_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="ofc_incnt_seq"/>]]></TD>
