...
<%@ taglib uri="clt-paging"   prefix="paging" %>
    ...
    <script type="text/javascript" src="./apps/fis/mgt/cust/ctrbmgn/script/MGT_MGN_0010.js"></script>
 				...
 				<tbody>
 					<tr>
		                ...
		                <td>
	                        ...
	                        <input type="text"   name="f_cust_nm" onblur="strToUpper(this);" class="search_form" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px;" onKeyPress="if(event.keyCode==13){doWork('CUST_POPLIST');}">
	                 	</td>
                        <td></td>
 					</tr>
 				</tbody>
