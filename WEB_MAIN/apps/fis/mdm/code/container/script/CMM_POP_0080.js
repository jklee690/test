        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                    sheetObj.DoSearch4Post("./CMM_POP_0080GS.clt", FormQueryString(formObj));
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('CMM_POP_0080_HDR'), true);

                //데이터속성    [ROW,  COL, DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,      KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0, 0,  dtData,     100,   daLeft,   false,    "cntr_tpsz_cd", false,      "",       dfNone,  	  0,     true,      true);
                InitDataProperty(0, 1,  dtData,     100,   daLeft,   false,    "iso_cntr_cd" , false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 2,  dtData,     200,   daLeft,   false,    "desc",		   false,      "",       dfNone,      0,     true,      true);
...
function sheet1_OnDblClick(sheetObj,Row,Col){
	...
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "desc");
