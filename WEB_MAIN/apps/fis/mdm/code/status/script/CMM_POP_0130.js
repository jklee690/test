        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                    sheetObj.DoSearch4Post("./CMM_POP_0130GS.clt", FormQueryString(formObj));
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('CMM_POP_0130_HDR'), true);

                //데이터속성    [ROW,  COL, DATATYPE,   WIDTH, DATAALIGN,  COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0, 0,  dtData, 	40,    daCenter,   false, 	 "",    	false,      "",       dfNone,  		0,     true,      true);
                InitDataProperty(0, 1,  dtData,     100,   daCenter,   false,    "cd_val",  false,      "",       dfNone,  		0,     true,      true);
                InitDataProperty(0, 2,  dtData,     200,   daLeft,     false,    "cd_nm", 	false,      "",       dfNone,       0,     true,      true);
