				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<TD><![CDATA[<bean:write name="row" property="gl_desc"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="chk_form"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="init_amt"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="curr_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="rvn_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cost_flg"/>]]></TD>
