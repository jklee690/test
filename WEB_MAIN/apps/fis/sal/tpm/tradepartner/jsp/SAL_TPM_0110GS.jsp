				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="visit_tm_fm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="pic_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="division"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="rgst_usrnm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="sls_his_tit"/>]]></TD>
							<TD <logic:notEmpty name="row" property="sls_his_flat_nm">IMAGE="0"</logic:notEmpty>></TD>
							<TD><![CDATA[<bean:write name="row" property="sls_his_flat_url"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="sls_his_flat_nm"/>]]></TD>
