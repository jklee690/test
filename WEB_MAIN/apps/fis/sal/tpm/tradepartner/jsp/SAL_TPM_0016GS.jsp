				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<TD><![CDATA[<bean:write name="row" property="cb_dest"    filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cb_trdp_cd" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cb_trdp_nm" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="rlt_prnr_tp_cd" filter="false"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="sheet6"/>]]></TD>
			            </tr>
					</logic:iterate>
					</DATA>
				</SHEET>
