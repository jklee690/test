...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/sal/tpm/tradepartner/script/SAL_TPM_0130.js"></script>
<script>
	function setupPage(){
	 	loadPage();
	}
				...
				<tbody>
					<tr>
						...
						<td><!-- 
						 ...
						 --><input type="text"   name="f_fm_trdp_nm" maxlength="50" onblur="strToUpper(this)" class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:300px;" onKeyPress="if(event.keyCode==13){doWork('PARTNER_POPLIST', document.getElementById('partner'), frm1.f_fm_trdp_nm.value);}"></td>
						<th><bean:message key="Merged_By"/></th>
						<td colspan="3"><input type="text"   name="rgst_usrid" value="" class="search_form-disable" tabindex="-1" style="width:75px;">
					</tr>
					<tr>
						...
						<td><!-- 
						 ...
						 --><input type="text"   name="f_to_trdp_nm" maxlength="50" onblur="strToUpper(this)" class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:300px;" onKeyPress="if(event.keyCode==13){doWork('PARTNER_POPLIST2', document.getElementById('partner'), frm1.f_to_trdp_nm.value);}"></td>
					</tr>
				</tbody>
			</table>
		</div>
