...
function doWork(srcName){
	...
	switch(srcName) {
		case "SEARCHLIST":
			...
			sheetObj.DoSearch4Post("SAL_TFM_0020GS.clt", FormQueryString(formObj));
		...
		case "SEARCHLIST01":
			...
			formObj.f_cmd.value = SEARCHLIST01;
				sheetObj1.DoSearch4Post("SAL_TFM_0020_1GS.clt", FormQueryString(formObj));
		...
		case "MODIFYHEADER":
			...
			if(confirm(getLabel('SAL_COM_ALT004'))){
				sheetObj.DoSave("SAL_TFM_0020GS.clt", FormQueryString(formObj),"ibflag",false);
//				sheetObj.DoAllSave("SAL_TFM_0020GS.clt", FormQueryString(formObj)+'&'+sht1,false);
			}
		break;
		case "MODIFYALL":
			...
			if(confirm(getLabel('SAL_COM_ALT004'))){
				sheetObj1.DoSave("SAL_TFM_0020GS.clt", FormQueryString(formObj),"dtl_ibflag",false);
//				sheetObj.DoAllSave("SAL_TFM_0020GS.clt", FormQueryString(formObj)+'&'+sht1,false);
			}
			// 저장 후 detail조회.
//			doWork('SEARCHLIST01');
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('SAL_TFM_0020_HDR1_1'), true);
                InitHeadRow(1, getLabel('SAL_TFM_0020_HDR1_2'), true);
         ...
         case 2:      //IBSheet1 init
             ...
             with (sheetObj) {
                ...
                // SheetWidth = 400;
                 ...
                 //해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
                 InitHeadRow(0, getLabel('SAL_TFM_0020_HDR2_1'), true);
                 InitHeadRow(1, getLabel('SAL_TFM_0020_HDR2_2'), true);
 				...
 				InitDataProperty(0,cnt++,  dtData,			60,    daCenter,	true,	"from_sec",		false,		"",       dfInteger,   0,     true,     true,		6);
 				InitDataProperty(0,cnt++,  dtData,			60,    daCenter,	true,	"to_sec",		false,		"",       dfInteger,   0,     true,     true,		6);
