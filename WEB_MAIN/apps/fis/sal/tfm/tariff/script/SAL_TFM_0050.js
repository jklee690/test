...
function doWork(srcName){
	...
	switch(srcName) {
		case "SEARCHLIST":
			...
			sheetObj.DoSearch4Post("SAL_TFM_0050GS.clt", FormQueryString(formObj));
		...
		case "SEARCHLIST01":
			...
			sheetObj1.DoSearch4Post("SAL_TFM_0050_1GS.clt", FormQueryString(formObj));
		...
		case "SEARCHLIST02":
			...
			sheetObj2.DoSearch4Post("SAL_TFM_0050_2GS.clt", FormQueryString(formObj));
		...
		case "ROWADD":
			...
			getObj('rowAdd3').style.display = 'none';
			getObj('rowAdd4').style.display = 'none';
			//rowAdd3.style.display = 'block';
...
//				var tmpSeq = 0;
//				var orgSeq = 0;
//				if(sheetObj1.Rows>2 && sheetObj1.CellValue(sheetObj1.LastRow, "trf_dtl_seq")!=""){
//					orgSeq = parseInt(sheetObj1.CellValue(sheetObj1.LastRow, "trf_dtl_seq"));
//				}
...
//				if(sheetObj2.Rows>2){
//					if(sheetObj2.CellValue(sheetObj2.LastRow, "trf_dtl_seq")!=""){
//						tmpSeq = parseInt(sheetObj2.CellValue(sheetObj2.LastRow, "trf_dtl_seq"));
//					}
//				}
//				if(tmpSeq > orgSeq){
//					sheetObj1.CellValue2(Row, "trf_dtl_seq") = tmpSeq + 1;
//				}else if(tmpSeq == orgSeq){
//					sheetObj1.CellValue2(Row, "trf_dtl_seq") = 1;
//				}else{
//					sheetObj1.CellValue2(Row, "trf_dtl_seq") = orgSeq + 1;
//				}
			}
		break;
		case "ROWADD3":
...
//				var tmpSeq = 0;
//				var orgSeq = 0;
//				if(sheetObj2.Rows>2 && sheetObj2.CellValue(sheetObj2.LastRow, "trf_dtl_seq")!=""){
//					orgSeq = parseInt(sheetObj2.CellValue(sheetObj2.LastRow, "trf_dtl_seq"));
//				}
				var iRows = sheetObj2.Rows;
				var Row = sheetObj2.DataInsert(++iRows);
				sheetObj2.CellValue2(Row, "trf_ctrt_no") = formObj.hid_trf_ctrt_no.value;

//				if(sheetObj1.Rows>2){
//					if(sheetObj1.CellValue(sheetObj1.LastRow, "trf_dtl_seq")!=""){
//						tmpSeq = parseInt(sheetObj1.CellValue(sheetObj1.LastRow, "trf_dtl_seq"));
//					}
//				}
//				if(tmpSeq > orgSeq){
//					sheetObj2.CellValue2(Row, "trf_dtl_seq") = tmpSeq + 1;
//				}else if(tmpSeq == orgSeq){
//					sheetObj2.CellValue2(Row, "trf_dtl_seq") = 1;
//				}else{
//					sheetObj2.CellValue2(Row, "trf_dtl_seq") = orgSeq + 1;
//				}
			}
		break;
		case "MODIFYHEADER":
			...
			if ( !fncGridCheckHeader() ) return false;
			if(confirm(getLabel('SAL_COM_ALT004'))){
				sheetObj.DoSave("SAL_TFM_0050GS.clt", FormQueryString(formObj),"ibflag",false);
//				sheetObj.DoAllSave("SAL_TFM_0050GS.clt", FormQueryString(formObj)+'&'+sht1,false);
			}
		break;
		case "MODIFY1":
			...
			// grid value validation
			if ( !fncGridCheckRate() ) return false;
			if(confirm(getLabel('SAL_COM_ALT004'))){
				sheetObj1.DoSave("SAL_TFM_0050GS.clt", FormQueryString(formObj),"dtl_ibflag",false);
//				sheetObj.DoAllSave("SAL_TFM_0050GS.clt", FormQueryString(formObj)+'&'+sht1,false);
			}
			// 저장 후 detail조회.
//			doWork('SEARCHLIST01');
		...
		case "MODIFY2":
			...
			if (sht2 == "") return false;			
			var sht		= sheetObj.GetSaveString(false);
			if (sht == ""&&sht2 == "") return false;

			// grid value validation
			if ( !fncGridCheckOther() ) return false;
			if(confirm(getLabel('FMS_COM_CFMSAV'))){
				sheetObj2.DoSave("SAL_TFM_0050GS.clt", FormQueryString(formObj),"dtl1_ibflag",false);
//				sheetObj.DoAllSave("SAL_TFM_0050GS.clt", FormQueryString(formObj)+'&'+sht1,false);
			}
			// 저장 후 detail조회.
//			doWork('SEARCHLIST01');
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('SAL_TFM_0050_HDR1_1'), true);
                InitHeadRow(1, getLabel('SAL_TFM_0050_HDR1_2'), true);
				...
				InitDataProperty(0,cnt++,  dtHidden,		100,    daLeft,    true,	"trdp_tp_cd", 	false,		"",       dfNone,      0,     true,      true,		100);
				
				InitDataProperty(0,cnt++,  dtHidden,		 70,    daLeft,    true,	"sell_buy_tp_cd",false,		"",       dfNone,      0,     true,      true,		6);
				
				InitDataProperty(0,cnt++,  dtHidden,         50,    daLeft,    true,	"bnd_clss_cd", 	false,		"",       dfNone,      0,     true,      true,		6);
				
				InitDataProperty(0,cnt++,  dtPopupEdit,	     70,    daLeft,    true,	"pol_cd", 		false,		"",       dfNone,	   0,     true,      true,		5);
				InitDataProperty(0,cnt++,  dtData,			 150,    daLeft,    true,	"pol_nm", 		false,		"",       dfNone,	   0,     true,     true,		5);
				InitDataProperty(0,cnt++,  dtPopupEdit,	     70,    daLeft,    true,	"pod_cd", 		false,		"",       dfNone,      0,     true,      true,		5);
				InitDataProperty(0,cnt++,  dtData,			 150,    daLeft,    true,	"pod_nm", 		false,		"",       dfNone,      0,     true,     true,		5);
			
				InitDataProperty(0,cnt++,  dtPopupEdit,	     100,    daCenter,  true,	"trf_term_fm_dt",false,		"",       dfDateYmd,   0,     true,      true,		10);
				InitDataProperty(0,cnt++,  dtPopupEdit,	     100,    daCenter,  true,	"trf_term_to_dt",false,		"",       dfDateYmd,   0,     true,      true,		10);
				
				InitDataProperty(0,cnt++,  dtHidden,         30,    daLeft,    true,	"delt_flg", 	false,		"",       dfNone,      0,     true,      true,		1);
         ...
         case 2:      //IBSheet1 init
             ...
             with (sheetObj) {
                ...
                // SheetWidth = 400;
                 ...
                 //해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
                 InitHeadRow(0, getLabel('SAL_TFM_0050_HDR2_1'), true);
                 InitHeadRow(1, getLabel('SAL_TFM_0050_HDR2_2'), true);
 				...
 				InitDataProperty(0,cnt++,  dtPopupEdit,		80,    daLeft,		true,	"frt_cd",		false,		"",       dfNone,      0,     true,     true,		10);
 				InitDataProperty(0,cnt++,  dtData,		   150,    daLeft,		true,	"frt_nm",		false,		"",       dfNone,      0,     false,     false,		50);
 				...
 				InitDataProperty(0,cnt++,  dtCombo,			60,    daCenter,	true,	"rt_clss_cd",	false,		"",       dfInteger,   0,     true,     true,		6);

 				InitDataProperty(0,cnt++,  dtData,		   120,    daRight,		true,	"trf_amt", 		false,		"",       dfFloat,     2,     true,     true,		25);
 				
 				InitDataProperty(0,cnt++,  dtData,		   100,    daLeft,		true,	"rmk",			false,      "",       dfNone,      0,	  true,     true,		100);
 				...
 				InitDataCombo (0, "rt_clss_cd", PARAM6_1, PARAM6_2);
         ...
         case 3:      //IBSheet1 init
             ...
             with (sheetObj) {
                ...
                // SheetWidth = 400;
                 ...
                 //해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
                 InitHeadRow(0, getLabel('SAL_TFM_0050_HDR3_1'), true);
                 InitHeadRow(1, getLabel('SAL_TFM_0050_HDR3_2'), true);
 				...
 				InitDataProperty(0,cnt++,  dtData,		   100,    daLeft,		true,	"rmk",			false,      "",       dfNone,      0,	  true,     true,		100);
 				InitDataProperty(0,cnt++,  dtHidden,        50,    daLeft,		true,	"trf_ctrt_no", 	false,		"",       dfNone,      0,     true,     true,		15);
 				InitDataProperty(0,cnt++,  dtHiddenStatus,	40,    daCenter,	true,	"dtl1_ibflag");
...
//			alert(i +' row '+getLabel('SAL_TFM_MSG06'));
...
function sheet2_OnSearchEnd() {
	...
	getObj('rowAdd3').style.display = 'block';
	getObj('rowAdd4').style.display = 'block';
	//rowAdd3.style.display = 'block';
...
function sheet3_OnChange(sheetObj,Row,Col){
	...
	case "frt_cd":
		codeNameAction('freight_o', sheetObj.cellValue(Row, Col), 'onChange')
		break;
...
function dispCodeNameAjaxReq(reqVal){
	...
	if(doc[0]=='OK'){
		if(typeof(doc[1])!='undefined'){
			...
			}else if(CODETYPE == "freight_o"){
				sheetObj2.cellValue2(sheetObj2.selectRow, "frt_cd") = masterVals[0]; 
				sheetObj2.cellValue2(sheetObj2.selectRow, "frt_nm") = masterVals[3];
			}
		}else{
			if(CODETYPE == "trdpCode"){
				...
				sheetObj2.cellValue2(sheetObj2.selectRow, "frt_cd") = ""; 
				sheetObj2.cellValue2(sheetObj2.selectRow, "frt_nm") = "";
			}
		}
	}else{
		//Error occurred
...
function fncGridCheckRate(){
	...
	for(var i=2 ; i<sheetObj1.rows ; i++){
		...
		if(sheetObj1.CellValue(i, 'frt_cd')==''){
			alert(getLabel('SAL_COM_ALT006') + "\n\n: SAL_TFM_0050.1162");
			sheetObj1.SelectCell(i, 'frt_cd');
			return false;
		}
	...
	function fncGridCheckOther(){
		...
		var modiyRowCnt =0;
		 ...
		 if(sheetObj2.rowcount<1){
			 alert(getLabel('SAL_COM_ALT007') + "\n\n: SAL_TFM_0050.2162");
			 return false;
		 }
		
		for(var i=2 ; i<sheetObj2.rows ; i++){
			
			if(sheetObj2.CellValue(i, 'frt_cd')==''){
				alert(getLabel('SAL_COM_ALT006') + "\n\n: SAL_TFM_0050.2162");
				sheetObj2.SelectCell(i, 'frt_cd');
				return false;
			}
		...
		if(sheetObj2.ColValueDup('frt_cd') > 0){
			alert(getLabel('SAL_COM_ALT005') + "\n\n: SAL_TFM_0010.939");
			sheetObj2.SelectCell(sheetObj2.ColValueDup('frt_cd'), 'frt_cd');
			return false;
		}
