...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/see/bmd/housebl/script/SEE_BMD_0150.js"></script>
	   			...
	   			<table><colgroup>
					...
					<tbody>
                        <tr>
                            ...
                            <td><input type="text" name="f_bl_no" maxlength="20" value='<bean:write name="coVO" property="doc_recpt_no"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="f_cnt_origin" maxlength="50" value='<bean:write name="coVO" property="cnt_origin"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
                        </tr>
                        <tr>
                            <th><bean:message key="Export_Carrier"/></th>
                            <td><input type="text" name="f_exp_carrier" maxlength="50" value='<bean:write name="coVO" property="exp_carrier"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
                        </tr>
                        <tr>
                            <th><bean:message key="Port_of_Loading"/></th>
                            <td><input type="text" name="f_pol_nm" maxlength="50" value='<bean:write name="coVO" property="pol_nm"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
                        </tr>
                        <tr>
                            <th><bean:message key="Port_of_Discharge"/></th>
                            <td><input type="text" name="f_pod_nm" maxlength="50" value='<bean:write name="coVO" property="pod_nm"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
                        </tr>
                        </tbody>
                    </table>
                    <table>
	                   <colgroup>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="f_chamber" maxlength="50" value='<bean:write name="coVO" property="chamber"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px" onblur="strToUpper(this);"></td>
                            <th><bean:message key="State"/></th>
                            <td><input type="text" name="f_state_nm" maxlength="50" value='<bean:write name="coVO" property="state_nm"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:113px" onblur="strToUpper(this);"></td>
                        </tr>
                        </tbody>
                    </table>
	   		</div>
