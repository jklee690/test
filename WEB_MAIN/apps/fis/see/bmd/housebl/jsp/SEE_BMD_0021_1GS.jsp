        ...
        <SHEET>
            ...
            <logic:iterate id="row" name="rowSet">
                        <tr>    
                            ...
                            <TD></TD>
                            <TD></TD>
                            <TD><![CDATA[<bean:write name="row" property="palt_ext_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="palt_doc_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="palt_doc_tp_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="palt_doc_tp_nm" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="palt_doc_img_nm" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="palt_doc_no" filter="false"/>]]></TD>
