...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/see/bmd/housebl/script/SEE_BMD_0063.js"></script>
                     ...
                     <tr>
                            ...
                            <tr>
                               ...
                               <td class="table_search_body">
                                   <textarea name="trdp_addr" class="search_form" style="width:325px;height:80px"><bean:write name="hmOutParam" property="trdp_addr"/></textarea>
                               </td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                               <th><bean:message key="Address"/></th>
                               <td>
                                   <textarea name="delivery_trdp_addr" class="search_form" style="width:325px;height:80px"><bean:write name="hmOutParam" property="delivery_trdp_addr"/></textarea>
                               </td>
                           </tr>
                           <tr>
                               <th><bean:message key="Tel_Fax"/></th>
