...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/see/bmd/housebl/script/SEE_BMD_0110.js"></script>
	<style>
<!--
td.table_body_c {
	...
	<div class="wrap_result">
		<div class="opus_design_inquiry">
			<table>
               ...
               <tr>
                  <td><!-- 
                   --><b><i><u>Pay to the Order of </u></i></b>&nbsp;<input type="text" name="txt_ship_nm" value="" onblur="strToUpper(this)" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:286px" class="search_form" onKeyDown="openPopup('CUSTOMER_POPLIST')"><!-- 
			...
			<table>
				...
				<tr>
					...
					<td width="463px"><!-- 
					 --><input type="text" name="txt_glt_nm" value="" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:350px" class="search_form" onKeyDown="openPopup('CUSTOMER_POPLIST3')"><!-- 
