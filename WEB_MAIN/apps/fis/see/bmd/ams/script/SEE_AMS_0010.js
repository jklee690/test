    ...
    switch(sheetNo) {
		case 1:      //IBSheet1 init
		    with (sheetObj) {
		      ...
		      var headers = [ { Text:'VSL|VOY|POL|POD|ETD|MB/LNo|HB/LNo|AMS File No.|ETA|Send Date|Send Msg|B/L Type|Loading|Discharge|lnr_trdp_cd|Carrier', Align:"Center"} ];
		      InitHeaders(headers, info);

		      var cols = [ {Type:"Text",      Hidden:0,  Width:120,  Align:"Left",    ColMerge:1,   SaveName:"trnk_vsl_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"trnk_voy",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"Text",      Hidden:0,  Width:120,  Align:"Center",  ColMerge:0,   SaveName:"send_dt",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:1,   SaveName:"hbl_tp",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		...
		break;
		 case 2:      //IBSheet1 init
		    with (sheetObj) {
		      ...
		      var info    = { Sort:1, ColMove:1, HeaderCheck:1, ColResize:1 };
		      var headers = [ { Text:"HB/LNo|Msg.Seq|Msg Type|Status|Disp|Result Message|Rcv.Date|intg_bl_seq", Align:"Center"} ];
		      InitHeaders(headers, info);

		      var cols = [ {Type:"Text",      Hidden:0,  Width:140,  Align:"Left",    ColMerge:0,   SaveName:"bl_no",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0 },
		             ...
		             {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"rcv_tms",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0 },
...
function sheet1_OnClick(sheetObj,Row,Col){
	var formObj=document.frm1;
	if(sheetObj.ColSaveName(Col) == "hbl_no"){
