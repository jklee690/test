...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/whm/shipping/shippinglist/script/WHM_WHM_0008.js"></script>
...
<!-- 	        	 --><input type="text" name="etd_strdt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkSearchFromToDate(false, document.frm1.etd_strdt, document.frm1.etd_enddt);" style="width:76px;" maxlength="10"><!--	        	 
                 --><span class="dash">~</span><!--
                 --><input type="text" name="etd_enddt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkSearchFromToDate(false, document.frm1.etd_strdt, document.frm1.etd_enddt);" style="width:76px;" maxlength="10"><!--
	   		...
	   		<tr>
				...
				<td>
           		...
           		<td ><input type="text" name="cust_cd" id="cust_cd" value="" class="search" onKeyDown="codeNameAction('CUSTUMER',this, 'onKeyDown')" onBlur="strToUpper(this);codeNameAction('CUSTUMER',this, 'onBlur')" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px" ><!-- 
           		 --><button type="button" class="input_seach_btn" tabindex="-1" id="billto" onclick="doWork('btn_Search_Cust')"></button><!-- 
           		 --><input type="text" name="cust_nm" id="cust_nm" value="" style="width:188px;" class="search" readOnly>
           		</td>
	   			<th><bean:message key="Delivery_To"/></th>
	   			<td><input type="text" name="splr_rcvr_cd" id="splr_rcvr_cd" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px;" maxlength="12" onKeyDown="codeNameAction('SUPPLIER',this, 'onKeyDown')" onBlur="strToUpper(this);codeNameAction('SUPPLIER',this, 'onBlur')" ><!-- 
				    --><button type="button" class="input_seach_btn" tabindex="-1" onclick="doWork('SU_POPLIST')"></button><!-- 
				    --><input type="text" name="splr_rcvr_nm" id="splr_rcvr_nm" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:151px;text-align:left" readOnly></td>
                    </td>
