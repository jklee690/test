...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/whm/shipping/shipping/script/WHM_WHM_0007.js"></script>
				...
				<td>
					<div class="opus_design_btn">
						...
						<button style="cursor:hand" type="button" class="btn_normal" onClick="setGrdSizeStup(docObjects[0], 12)"><bean:message key="Minus"/></button>	
   						<button type="button" class="btn_normal"  name="btn_invt_add" id="btn_invt_add" onclick="doWork('INVT_ADD')"><bean:message key="Load_W/H"/></button>
   						<button type="button" class="btn_normal"  name="btn_add" id="btn_add" onclick="doWork('ROWADD')"><bean:message key="Add"/></button>
   					</div>
   				</td>
			</tr>
		</tbody>
