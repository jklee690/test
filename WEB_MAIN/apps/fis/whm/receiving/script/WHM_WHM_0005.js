...
function OpenCustItmPop(colValue){
	...
	var sUrl="CtrtItemPopup.clt?ctrt_no="+formObj.s_ctrt_no.value+"&item_cd="+colValue;
    ...
    switch(sheetNo) {
         case 1:      //IBSheet1 init
            with (sheetObj) {
	           ...
	           var HeadTitle2 = "|DEL|Item|Item|Unit|Inner Qty.|Ctn.|EA|Total Qty|Location|Item Description|P/O No.|L|W|H|KGS|LBS|KGS|LBS|CBM|CFT" ;
...
//				break;
			...
			case "itm_hgt":
				...
				if(formObj.f_len_ut_cd[0].checked){
					...
					sheetObj.SetCellValue(row, "itm_dim_wgt_lbs",(kg / 0.453597315).toFixed(2),0);
					sheetObj.SetCellValue(row, "itm_act_wgt",kg.toFixed(3),0);
					sheetObj.SetCellValue(row, "itm_act_wgt_lbs",(kg / 0.453597315).toFixed(2),0);
				...
				break;
			case "itm_dim_wgt":
				sheetObj.SetCellValue(row, "itm_dim_wgt_lbs",roundXL(sheetObj.GetCellValue(row, col) / 0.453597315, 2),0);
				break;
			case "itm_dim_wgt_lbs":
				sheetObj.SetCellValue(row, "itm_dim_wgt",roundXL(sheetObj.GetCellValue(row, col) * 0.453597315, 2),0);
				break;
			case "itm_act_wgt":
				sheetObj.SetCellValue(row, "itm_act_wgt_lbs",roundXL(sheetObj.GetCellValue(row, col) / 0.453597315, 2),0);
				break;
			case "itm_act_wgt_lbs":
				sheetObj.SetCellValue(row, "itm_act_wgt",roundXL(sheetObj.GetCellValue(row, col) * 0.453597315, 2),0);
				break;
			case "itm_vol":
...
function chkSizeType(){
	...
	for(var i=2 ; i<sheetObj.LastRow(); i++){
		...
		if(formObj.f_len_ut_cd[0].checked){
			...
			sheetObj.SetCellValue(i, "itm_dim_wgt_lbs",(kg / 0.453597315).toFixed(2),0);
			sheetObj.SetCellValue(i, "itm_act_wgt",kg.toFixed(3),0);
			sheetObj.SetCellValue(i, "itm_act_wgt_lbs",(kg / 0.453597315).toFixed(2),0);
...
function loadSizeType(){
	...
	for(var i=2 ; i<sheetObj.LastRow(); i++){
		...
		if(formObj.f_len_ut_cd[0].checked){
			...
			sheetObj.SetCellValue(i, "itm_dim_wgt_lbs",parseFloat(sheetObj.GetCellValue(i, "itm_dim_wgt_lbs"))!=0 ? parseFloat(sheetObj.GetCellValue(i, "itm_dim_wgt_lbs")) :(kg / 0.453597315).toFixed(2) ,0);
			...
			sheetObj.SetCellValue(i, "itm_act_wgt_lbs",parseFloat(sheetObj.GetCellValue(i, "itm_act_wgt_lbs"))!=0 ? parseFloat(sheetObj.GetCellValue(i, "itm_act_wgt_lbs")) :(kg / 0.453597315).toFixed(2) ,0);
