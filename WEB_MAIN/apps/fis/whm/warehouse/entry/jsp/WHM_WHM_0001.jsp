...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/whm/warehouse/entry/script/WHM_WHM_0001.js"></script>
					 		...
					 		<tr>
					   		...
					   		<tr>
					 			<th><bean:message key = "Phone" /></th>
					           	<td>
					           		<input type="text" name=TxtPhone id="TxtPhone" value="" maxlength="12" onkeydown = 'PhoneFormat(event)' onchange='validFaxPhone(this)' onkeypress = 'validatePhone(event)' style="width:130px;" class="search_form">
					 			</td>
					 			<th><bean:message key = "Fax" /></th>
					 			<td><input type="text" name=TxtFax id="TxtFax" value="" onkeydown = 'FaxFormat(event)' onchange='validFaxPhone(this)' onkeypress = 'validateFax(event)' maxlength="12" style="width:100%;" align="right"  class="search_form"></td>
					 			<td></td>
					   		</tr>
					   		<tr>
