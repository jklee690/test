...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0042.js"></script>
	...
	<div class="page_title_area clear">
				...
				<div class="opus_design_btn"><!-- 
					...
					--><span id="printBtn02" style="display:none;"><button type="button" class="btn_normal" id="btnPrint" onclick="doWork('PRINT')" style="display: none;" btnAuth="<%= roleBtnVO.getAttr5() %>"><bean:message key="Print"/></button></span><!-- 
			        ...
			        <tbody>
						<tr>
	                        ...
	                        <td><!-- 
					             ...
					             --><input type="text" name="s_vendor_nm" id="s_vendor_nm" maxlength="50" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:136px" onKeyDown="custEnterAction(this,'CUSTOMER')" class="search_form">
	                        </td>
			...
			<table>	
			        ...
			        <tbody>
							<tr>
		                        ...
		                        <td>
						            <input type="text" name="s_chk_no" id="s_chk_no" maxlength="20"  value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:219px" class="search_form">
		                        </td>
