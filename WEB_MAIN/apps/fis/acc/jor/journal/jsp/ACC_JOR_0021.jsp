...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0021.js" ></script>
		...
		<div class="opus_design_inquiry">
			<table>	
			        ...
			        <tbody>
						...
						<td><input style="width:75px" id="s_post_strdt" name="s_post_strdt" maxlength="10" onkeyup="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_post_enddt);firCalFlag=false;" size="11" class="search_form" type="text" /><span class="dash">~</span><!-- 
						...
						<th><bean:message key="Received_From"></bean:message></th>
                        <td><input id="s_rcv_from_cd" name="s_rcv_from_cd" maxlength="20" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:50px;" onkeydown="codeNameAction('BILLTO',this, 'onKeyDown')" onblur="strToUpper(this);codeNameAction('BILLTO',this, 'onBlur')" class="search_form" type="text" /><!-- 
							...
							--><input id="s_rcv_from_nm" name="s_rcv_from_nm" maxlength="50" value="" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:122px;" onkeydown="custEnterAction(this,'CUSTOMER')" class="search_form" type="text" /></td>
						<th><bean:message key="Branch"></bean:message></th>
                        <td class="table_search_body">
                            <bean:define id="oficeList" name="valMap" property="ofcList"/>
                            <select required name="s_ofc_cd" style="width:180px;">
					...
					<tr>
						...
						<td><input style="width:75px" id="s_deposit_strdt" name="s_deposit_strdt" maxlength="10" onkeyup="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_deposit_enddt);firCalFlag=false;" size="11" class="search_form" type="text" /><span class="dash">~</span><!-- 
                        ...
                        <td><input id="s_chk_no" name="s_chk_no" maxlength="20" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:205px;" class="search_form" type="text" /></td>
			...
			<table>
				<colgroup>
			        ...
			        <tbody>
						...
						<td><input style="width:75px" id="s_void_strdt" name="s_void_strdt" maxlength="10" onkeyup="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_void_enddt);firCalFlag=false;" size="11" class="search_form" type="text" /><span class="dash">~</span><!-- 
						...
						<td><input id="s_issued_by" name="s_issued_by" maxlength="12" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px;" class="search_form" type="text" /></td> 
					</tr>
				</tbody>
			</table>
		</div>	
