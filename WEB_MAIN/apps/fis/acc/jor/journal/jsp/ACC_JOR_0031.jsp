...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0031.js" ></script>
			    	...
			    	<table>
						...
						<tbody>
							<tr>
		                        ...
		                        --><input type="text" name="s_cust_nm" maxlength="50" value="" onKeyDown="custEnterAction(this,'CUSTOMER')" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:144px" required></td>
							</tr>
							<tr>
						...
						<table>
							...
							<tbody>
								...
								<tr>
			                        ...
			                        <td><input type="text" name="f_chk_no" maxlength="20" value="" onblur="strToUpper(this);chkNoChg();" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px" ></td>
								</tr>
							</tbody>
						</table>
						<table>
