...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0011.js" ></script>
...
<form name="frm1" method="POST" action="./ACC_JOR_0011.clt">
   ...
   <!-- Button -->
	<div class="page_title_area clear">
	   ...
	   --><button type="button" btnAuth="CLEAR" class="btn_normal" onclick="clearAll()" style="display:none"><bean:message key="New"/></button><!--
	   --><button type="button" btnAuth="<%= roleBtnVO.getAttr6() %>" 	class="btn_normal" onclick="doWork('EXCEL')" style="display:none" name="btn_DownExcel"><bean:message key="Excel"/></button></div>
...
<div class="wrap_search wrap_result_tab" style="padding-bottom: 0px;">
			    	...
			    	<table>
						...
						<tbody>
							<tr>
		                        ...
		                        --><input required type="text" name="s_cust_nm" maxlength="50" value="" onKeyDown="custEnterAction(this,'CUSTOMER')" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:148px" ></td>
							</tr>
							<tr>
		            ...
		            <table>
		            	...
		            	<tbody>
							<tr>
		                        ...
		                        <td><input required type="text" name="f_rcv_from" maxlength="50" value="" onKeyDown="custEnterAction(this,'CUSTOMER2')" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:200px" ></td>
		                        <th><bean:message key="Post_Date"/></th>
		                        <td><!--
		                        --><input  required type="text" name="f_post_dt" id="f_post_dt" value=""  maxlength="10" onKeyUp="mkDateFormatType(this, event, false,1);" onBlur="mkDateFormatType(this, event, true,1);dateRangeValid(this, 'Post Date');checkPostDate();setPostDt();" dataformat="excepthan" style="ime-mode:disabled;width:75px;"><!--
		                        ...
		                        <td><input type="text" name="f_rcv_amt" value="" style="width:120px;text-align:right" class="search_form-disable" readOnly></td>
							</tr>
							
							<tr>
								<th><bean:message key="Deposit_Bank"/></th>
		                        <td><!--
		                        --><select required name="f_bank_cd" style="width:200px;" onChange="chageBankCurrCd(this);" ><!--
		                        --><option value=""></option><!--
								...
								<td><input type="text" name="f_chk_no" maxlength="20" value="" onblur="strToUpper(this);chkNoChg();" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px" ></td>
							</tr>
		            	</tbody>
		            </table>
		            <table>
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" name="f_deposit_dt" value=""  maxlength="10" onKeyUp="mkDateFormatType(this, event, false,1);" onBlur="mkDateFormatType(this, event, true,1);dateRangeValid(this, 'Deposit Date');chkDate(this, frm1.deposit_chk);checkDeposit();" dataformat="excepthan" style="ime-mode:disabled;width:75px;"><!--
    ...
    <div class="wrap_result">
       ...
       --><button type="button" class="btn_normal" name="btn_delete" id="invBtn02" onclick="searchInvList('INVADD')"><bean:message key="Invoice_Add"/></button></div>
