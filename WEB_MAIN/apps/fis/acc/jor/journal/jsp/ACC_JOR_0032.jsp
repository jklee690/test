...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0032.js" ></script>
		    	...
		    	<table>
		    		...
		    		<tbody>
						<tr>
	                        ...
	                        --><input required type="text"  name="s_cust_nm" maxlength="50" value="" onKeyDown="custEnterAction(this,'CUSTOMER')" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:165px" ></td>
	                        <td></td>
						</tr>
						<tr>
		            ...
		            <table>
		            	...
		            	<tbody>
							<tr>
		                        ...
		                        --><input required type="text" name="s_paid_nm" maxlength="50" value="" onKeyDown="custEnterAction(this,'CUSTOMER2')" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:132px" ></td>
		                        ...
		                        --><button id="f_post_dt_cal" type="button" onclick="doDisplay('DATE3', frm1);" class="calendar" tabindex="-1"></button></td>
							</tr>
							
							<tr>
								<th><bean:message key="Bank"/></th>
		                        <td><!--
		                        --><select name="f_bank_cd" style="width:215px;" onChange="chageBankCurrCd(this);setBankCurChkNo();" required><!--
		                        ...
		                        <td><input type="text" name="f_chk_no" maxlength="20" value="" onblur="strToUpper(this);chkNoChg();" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:105px" ></td>
							</tr>
							</tbody>
						</table>
						<table>
							...
							<tbody>
							<tr>
								<th><label for="deposit_chk" style="background-color:#d4f6ff;">Clear</label></th>
		                        ...
		                        <th><label for="block_chk" style="background-color:#d4f6ff;"><bean:message key="Block"/></label></th>
		                        <td><input type="checkbox" name="block_chk" id="block_chk" checked onclick="fn_block_chk()"></td>
		                        <th><label for="Office_Block"  style="background-color:#d4f6ff;"><bean:message key="Office_Block"/></label></th>
    ...
    <div class="wrap_result">
    	<div class="opus_design_grid" id="mainTable">
    		<div class="opus_design_btn"><!--
		       ...
		       --><button type="button" class="btn_normal" name="btn_delete" id="invBtn02" onclick="searchInvList('INVADD')"><bean:message key="Invoice_Add"/></button>
		    </div>
