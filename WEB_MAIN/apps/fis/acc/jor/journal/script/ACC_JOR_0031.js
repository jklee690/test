         ...
         case 1:      //IBSheet1 init
            with (sheetObj) {
	          ...
	          var cols = [ {Type:"CheckBox",  Hidden:0, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"del_chk",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1, HeaderCheck:0 },
	              ...
	              {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"chk_flag",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
	          ...
	          SetSheetHeight(390);
 	          SetColProperty(0 ,"gl_rmk", {AcceptKeys:"E|N|[-~!@#$^&*()_+| ]", InputCaseSensitive:1}); // 영대문자+숫자+특수키+스페이스만
 	          SetColProperty(0 ,"bl_no", {AcceptKeys:"E|N|[-~!@#$^&*()_+| ]", InputCaseSensitive:1});	// 영대문자+숫자+특수키+스페이스만	
 	          SetColProperty(0 ,"ref_no", {AcceptKeys:"E|N|[-~!@#$^&*()_+| ]", InputCaseSensitive:1}); // 영대문자+숫자+특수키+스페이스만		
 	         resizeSheet();
         }                                                     
         break;
...
//		getObj('btnRiderPrint').style.display = "inline";
...
//	getObj('btnRiderPrint').style.display = "none";
