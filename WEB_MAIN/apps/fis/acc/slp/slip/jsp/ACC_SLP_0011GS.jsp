<%--
=========================================================
*@FileName   : ACC_SLP_0011GS.jsp
*@FileTitle  : Slip Creation Verify
*@Description: Slip Creation Verify
				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
                            ...
                            <TD><![CDATA[<bean:write name="row" property="error"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="m_type"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="m_seq"/>]]></TD>
							<TD></TD>
			            </tr>
					</logic:iterate>
					</DATA>
