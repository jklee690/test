        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                    sheetObj.DoSearch4Post("EQU_POP_0120GS.clt", FormQueryString(formObj));
...
//	alert("arg===>["+arg[1]+"]");
	...
	if(arg[1]!=undefined)
		formObj.inv_no.value = arg[1];
	if(arg[2]!=undefined)
		formObj.cntr_tpsz_cd.value = arg[2];
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('EQU_POP_0120_HDR'), true);

                //데이터속성    [ROW,   COL,   DATATYPE,       WIDTH, DATAALIGN, COLMERGE, SAVENAME,    KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0, 0,  dtData,     	 50,   daCenter, false,    "no",    	false,      "",       dfNone,  	   0,     true,      true);
                InitDataProperty(0, 1,  dtData,          120,   daLeft,   false,    "tpsz_amt" ,	false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 2,  dtHidden,        120,   daLeft,   false,    "cntr_tpsz_cd" ,	false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 3,  dtHidden,        120,   daLeft,   false,    "inv_smry_seq" ,	false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 4,  dtHidden,        120,   daLeft,   false,    "tpsz_cnt" ,	false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 5,  dtHidden,        120,   daLeft,   false,    "amt" ,	false,      "",       dfNone,      0,     true,      true);
...
function sheet1_OnDblClick(sheetObj,Row,Col){
	...
	retArray += sheetObj.CellValue(Row, "amt");
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "inv_smry_seq");
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "cntr_tpsz_cd");
