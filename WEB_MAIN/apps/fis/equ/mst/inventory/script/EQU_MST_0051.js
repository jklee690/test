        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                    sheetObj.DoSearch4Post("EQU_MST_0051GS.clt", FormQueryString(formObj));
 ...
 */
function viewCntChg(){
	document.frm1s[0].f_CurPage.value = 1;
	doWork('SEARCHLIST');
}
...
//	formObj.inv_sts_cd.value = arg[1];
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('EQU_MST_0051_HDR'), true);

                //데이터속성    [ROW,   COL,   DATATYPE,       WIDTH, DATAALIGN, COLMERGE, SAVENAME,    KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0, 0,  dtData,     	 50,   daCenter, false,    "no",    	false,      "",       dfNone,  	   0,     true,      true);
                InitDataProperty(0, 1,  dtData,          80,   daLeft,   false,    "cd_val" ,	false,      "",       dfNone,      0,     true,      true);
                InitDataProperty(0, 2,  dtData,        80,   daLeft,   false,    "cd_nm" ,	false,      "",       dfNone,      0,     true,      true);
...
function sheet1_OnDblClick(sheetObj,Row,Col){
	...
	retArray += sheetObj.CellValue(Row, "cd_val");
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "cd_nm");
