        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                    sheetObj.DoSearch4Post("EQU_POP_0010GS.clt", FormQueryString(formObj));
...
//	alert("arg===>["+arg[1]+"]");
	...
	if(arg[1]!=undefined)
	formObj.lr_trdp_cd.value = arg[1];
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitHeadRow(0, getLabel('EQU_POP_0010_HDR'), true);

                //데이터속성    [ROW,   COL,   DATATYPE,       WIDTH, DATAALIGN, COLMERGE, SAVENAME,    KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0, 0,  dtData,     	 40,   daCenter, false,    "no",    	false,      "",       dfNone,  	   0,     true,      true);
                InitDataProperty(0, 1,  dtData,          100,   daLeft,   false,    "agmt_no" ,	false,      "",       dfNone,      0,     false,      false);
                InitDataProperty(0, 2,  dtData,           80,   daLeft,   false,    "ref_no" ,	false,      "",       dfNone,      0,     false,      false);
                InitDataProperty(0, 3,  dtCombo,          50,   daLeft,   false,    "lstm_cd" ,	false,      "",       dfNone,      0,     false,      false);
                InitDataProperty(0, 4,  dtHidden,         50,   daLeft,   false,    "lr_trdp_cd" ,	false,      "",       dfNone,      0,     false,      false);
                InitDataProperty(0, 5,  dtHidden,         50,   daLeft,   false,    "curr_cd" ,	false,      "",       dfNone,      0,     false,      false);
      			
                //콤보항목설정[ROW, COL, COMBO-TEXT, COMBO-CODE, DEFAULT-TEXT]
                 InitDataCombo (0, 3, "COC|SOC|OWN",        "C|S|O");
...
function sheet1_OnDblClick(sheetObj,Row,Col){
	...
	retArray += sheetObj.CellValue(Row, "agmt_no");
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "lr_trdp_cd");
	retArray += "|";
	retArray += sheetObj.CellValue(Row, "curr_cd");
