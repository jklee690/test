      ...
      break;
       ...
       case "CONTRY_LIST" :
		...
		case "FREIGHT_LIST" :
			...
			var rtnVal = window.showModalDialog('./CMM_POP_0070.clt', rtnary, "scroll:yes;status:no;help:no;dialogWidth:560px;dialogHeight:480px");
         ...
         case 1:      //IBSheet1 init
            ...
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
				...
				InitDataProperty(0, 2,  dtData,   		  40,   daCenter,  true,    "no",			false,   "",       dfNone,      0,     false,     false,	2);
				InitDataProperty(0, 3,  dtPopupEdit,      60,   daLeft,    false,   "pol_cd",		 true,   "",       dfNone,      0,     false,      true,		10);
				InitDataProperty(0, 4,  dtData,			 120,   daLeft,    false,   "pol_nm",		false,   "",       dfNone,      0,     false,      false,		10);
				InitDataProperty(0, 5,  dtPopupEdit,   	  60,   daLeft,    false,   "pod_cd",		 true,   "",       dfNone,      0,     false,      true,		10);                
				InitDataProperty(0, 6,  dtData,			 120,   daLeft,    false,   "pod_nm",		false,   "",       dfNone,      0,     false,      false,		10);                
				InitDataProperty(0, 7,  dtData,           80,   daRight,   false,   "to_dis_day",	false,   "",       dfInteger,   0,     true,      true,		3);
				InitDataProperty(0, 8,  dtData,      	  80,   daRight,   true,    "to_bod_day",	false,   "",       dfInteger,   0,     true,      true,		3);
				InitDataProperty(0, 9,  dtData,		      80,   daRight,   true,    "to_fd_day",	false,   "",       dfInteger,   0,     true,      true,		3);
				InitDataProperty(0,10,  dtPopupEdit,   	  60,   daLeft,    true,    "fd_cd",		 true,   "",       dfNone,      0,     false,      true,		10);
				InitDataProperty(0,11,  dtData,		  	  120,  daLeft,    true,    "fd_nm",		false,   "",       dfNone,      0,     false,      false,		10);
...
function sheet1_OnChange(sheetObj,Row,Col){
	...
	case "pod_cd":
		...
		break;
	case "fd_cd":
		codeNameAction('country_s',sheetObj.cellValue(Row, Col), 'onChange')
		break;
