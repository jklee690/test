				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="mst_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cur_loc_cd"/>]]></TD>
			            </tr>
					</logic:iterate>
					</DATA>
				</SHEET>
