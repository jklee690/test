...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/aie/bmd/masterbl/script/AIE_BMD_0310.js"></script>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							--><input type="text" name="f_pol_nm" id="f_pol_nm" maxlength="50" class="search_form" style="ime-mode:disabled; text-transform:uppercase;width:180px;text-transform:uppercase;" onblur="strToUpper(this);" onKeyPress="if(event.keyCode==13){locOpenPopUp(document.getElementById('pol'), 'A');}">
						</td>
						...
						<td>
							...
							--><input type="text" name="f_pod_nm" id="f_pod_nm" maxlength="50" class="search_form" style="ime-mode:disabled; text-transform:uppercase;width:180px;text-transform:uppercase;" onblur="strToUpper(this);" onKeyPress="if(event.keyCode==13){locOpenPopUp(document.getElementById('pod'), 'A');}">
						</td>
