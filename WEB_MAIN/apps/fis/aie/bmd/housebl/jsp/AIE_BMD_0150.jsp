...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/aie/bmd/housebl/script/AIE_BMD_0150.js"></script>
	   			...
	   			<table>
					...
					<tbody>
	                     <tr>
	                         ...
	                         <td><input type="text" name="f_bl_no" maxlength="20" value='<bean:write name="coVO" property="bl_no"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px" onblur="strToUpper(this);"></td>
	                     </tr>
	                     <tr>
	                         ...
	                         <td><!-- 
	                          ...
	                          --><button type="button" class="calendar" tabindex="-1" id="f_bl_dt_cal" onclick="doDisplay('DATE1' ,frm1);"></button><!-- 
	                          --></td>
	                     </tr>
	                     <tr>
	                     ...
	                     <tr>
	                         ...
	                         <td><input type="text" name="f_exp_carrier" maxlength="50" value='<bean:write name="coVO" property="exp_carrier"/>' onblur="strToUpper(this)" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px"></td>
	                     </tr>
	                     <tr>
