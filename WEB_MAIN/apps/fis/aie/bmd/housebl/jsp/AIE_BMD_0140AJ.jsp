...
=========================================================
=========================================================
*@FileName   : AIE_BMD_0140AJ.jsp
*@FileTitle  : AEH Packing List
*@Description: 
*@author     : TinLuong - Dou
...
<logic:empty name="com.clt.framework.core.comm.EXCEPTION_OBJECT      ">
	<logic:notEmpty name="EventResponse" property="mapVal">
		...
		<DATA>
			...
			<grs_wgt><![CDATA[<bean:write name="plVO" property="grs_wgt" filter="false" />]]></grs_wgt>
			<chg_wgt><![CDATA[<bean:write name="plVO" property="chg_wgt" filter="false" />]]></chg_wgt>
			<meas><![CDATA[<bean:write name="plVO" property="meas" filter="false" />]]></meas>
