...
<div class="layout_wrap">
        ...
        <div class="opus_design_inquiry">
			...
			<table>
				<tr>
					...
					<td><input type="text" maxlength="50"   name="s_shp_nm" value="<bean:write name="hblVO" property="shp_nm"/>"  onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){companyPopup('USPPI',frm1.s_shp_nm.value);}" dataformat="excepthan" style="ime-mode:disabled;width:175px;text-transform:uppercase;"><!-- 
				...
				<tr>
					...
					<td><!-- 
					 --><input type="text" maxlength="9"   name="s_shp_zip" value="<bean:write name="hblVO" property="shp_zip"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!-- 
				...
				<tr>
					...
					<td><!-- 
					 ...
					 --><input type="text"   maxlength="20"  name="s_shp_id" value="<bean:write name="hblVO" property="shp_id"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!-- 
					 --></td>
				</tr>
			</table>
			...
			<table>
				<tr>
					<th width="130px"><bean:message key="Name"/></th>
					<td><input type="text"   name="s_ult_cnee_nm"  maxlength="50" value="<bean:write name="hblVO" property="ult_cnee_nm"/>"  onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){companyPopup('ULT',frm1.s_ult_cnee_nm.value);}" dataformat="excepthan" style="ime-mode:disabled;width:175px;text-transform:uppercase;"><!-- 
					 --><button type="button" class="input_seach_btn" tabindex="-1" onClick="companyPopup('ULT');"></button></td>
	            </tr>
				<tr>
					<th><bean:message key="Contact_Name"/></th>
					<td><input type="text"   name="s_ult_cnee_pic" maxlength="50"  value="<bean:write name="hblVO" property="ult_cnee_pic"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"></td>
				</tr>
				<tr>
					<th><bean:message key="Phone"/></th>
    ...
    <div class="layout_vertical_2 sm mar_left_8" style="width:calc(60% - 10px)">
        <div class="opus_design_inquiry">
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th width="130px"><bean:message key="Name"/></th>
					<td><!-- 
					 --><input type="text"  maxlength="50"    name="s_fwd_nm" value="<bean:write name="hblVO" property="fwd_nm"/>"  onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){companyPopup('FWD',frm1.s_fwd_nm.value);}" dataformat="excepthan" style="ime-mode:disabled;width:165px;text-transform:uppercase;"><!-- 
					 --><button type="button" class="input_seach_btn" tabindex="-1" onClick="companyPopup('FWD');"></button></td>
	            </tr>
				<tr>
					<th><bean:message key="Contact_Name"/></th>
					<td><input type="text"  maxlength="50"   name="s_fwd_pic" value="<bean:write name="hblVO" property="fwd_pic"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"></td>
				</tr>
				<tr>
					<th><bean:message key="Phone"/></th>
					<td><input type="text"  maxlength="30"   name="s_fwd_phn" value="<bean:write name="hblVO" property="fwd_phn"/>" onkeyPress="onlyIntCheck();" onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:190px;text-transform:uppercase;"></td>
				</tr>
				<tr>
					<th><bean:message key="Address"/></th>
				...
				<tr>
					...
					<td><select name="s_fwd_tax_type" style="width:150;"><!-- 
					 ...
					 --><input type="text"   maxlength="20"  name="s_fwd_id" value="<bean:write name="hblVO" property="fwd_id"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!-- 
					 --></td>
				</tr>
			</table>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<th width="130px"><bean:message key="Name"/></th>
					<td><!-- 
					 --><input type="text"   maxlength="50" name="s_inter_cnee_nm" value="<bean:write name="hblVO" property="inter_cnee_nm"/>"  onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){companyPopup('INTER',frm1.s_inter_cnee_nm.value);}" dataformat="excepthan" style="ime-mode:disabled;width:165px;text-transform:uppercase;"><!-- 
					 --><button type="button" class="input_seach_btn" tabindex="-1" onClick="companyPopup('INTER');"></button></td>
		            </tr>
				<tr>
					<th><bean:message key="Contact_Name"/></th>
					<td><input type="text"  maxlength="50" name="s_inter_cnee_pic" value="<bean:write name="hblVO" property="inter_cnee_pic"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"></td>
				</tr>
				<tr>
					<th><bean:message key="Phone"/></th>
					<td><input type="text"  maxlength="30" name="s_inter_cnee_phn" value="<bean:write name="hblVO" property="inter_cnee_phn"/>" onkeyPress="onlyIntCheck();" onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:190px;text-transform:uppercase;"></td>
				</tr>
				<tr>
					<th><bean:message key="Address"/></th>
				...
				<tr>
					...
					<tr>
						<th><bean:message key="Postal_Code_Country"/></th>
						<td><input type="text"  maxlength="9"   name="s_inter_cnee_zip" value="<bean:write name="hblVO" property="inter_cnee_zip"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!-- 
