...
<link href="<%=CLT_PATH%>/style/css/theme_default.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" src="./apps/fis/aie/bmd/housebl/script/AIE_BMD_0060.js"></script>
					...
					<colgroup>
				        ...
				        <tbody>
							<tr>
                                ...
                                <th><bean:message key="ETD"/></h>
                                <td><!-- 
									--><input style="width:75px" type="text" name="etd_strdt" id="etd_strdt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, this, frm1.etd_enddt);firCalFlag=false;" size='10' maxlength="10" class="search_form">~  <!--
									--><input style="width:75px" type="text" name="etd_enddt" id="etd_enddt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, frm1.etd_strdt, this);firCalFlag=false;" size='10' maxlength="10" class="search_form"><!--
                                ...
                                <td><!--
                                	--><input type="text" name="f_prnr_trdp_nm" id="f_prnr_trdp_nm" maxlength="50"  class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:75px;" onKeyPress="if(event.keyCode==13){doWork('PRNR_TRDP_POPLIST', frm1.f_prnr_trdp_nm.value);}"/><!--
	                        ...
	                        <tr>
                                ...
                                <td><!-- 
                                       --><input type="text" name="f_shpr_trdp_nm" id="f_shpr_trdp_nm" maxlength="50" class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:75px;" onKeyPress="if(event.keyCode==13){doWork('SHIP_TRDP_POPLIST', frm1.f_shpr_trdp_nm.value);}"/><!-- 
									--><button type="button" class="input_seach_btn" tabindex="-1" onclick="doWork('SHIP_TRDP_POPLIST')"></button>
                                </td>
                                <th><bean:message key="Notify"/></th>
                                <td><!-- 
                                   	--><input type="text" maxlength="50" name="f_ntfy_trdp_nm" id="f_ntfy_trdp_nm" class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:105px;" onKeyPress="if(event.keyCode==13){doWork('NTFY_TRDP_POPLIST', frm1.f_ntfy_trdp_nm.value);}"/><!-- 
                                ...
                                <td>
									...
									<select name="f_inco_cd" id="f_inco_cd" style="width:51px;">
                                                   <option value=''>ALL</option>
                                ...
                                <td>
                                    <div id="div_subcode">
                                        ...
                                        <select name="f_ofc_cd" id="f_ofc_cd" style="width:110px;">
                            ...
                            <tr>
                                ...
                                <td><!-- 
                                    ...
                                    --><input type="text"   name="f_pod_nm" id="f_pod_nm" maxlength="50"   class="search_form" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:110px;" onKeyPress="if(event.keyCode==13){doWork('POD_LOCATION_POPLIST', frm1.f_pod_nm.value);}"/>
                                </td>
                                <th><bean:message key="Customer"/></th>
                                <td><!-- 
                                    --><input type="text" name="f_ahpr_trdp_nm" id="f_ahpr_trdp_nm" maxlength="50" class="search_form" dataformat="multiLanguage" style="<%=MULTI_IMEMODE%>text-transform:uppercase;width:75px;" onKeyPress="if(event.keyCode==13){doWork('ASHIP_TRDP_POPLIST', frm1.f_ahpr_trdp_nm.value);}"/><!-- 
                                ...
                                <td>
									<input type="text" name="f_flt_no" id="f_flt_no" maxlength="20" value='' class="search_form" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:105px;" onkeydown="entSearch();">
								</td>
                       			<td><!--
                       				--><select name="f_search_no_tp" id="f_search_no_tp" class="search_form" style="width:110px;" onChange="frm1.f_search_no.value=''">
                                           <option value="LC"><bean:message key="LC_No"/></option>
                                           <option value="PO"><bean:message key="PO_No"/></option>
                                        ...
                                        --><input id="f_po_no" name="f_po_no" value="" type="hidden" /><!-- 
                          		...
                          		<td colspan="3"><!--
								    --><input type="text" name="f_search_no" id="f_search_no" maxlength="40" value='' class="search_form" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:195px;" onkeydown="entSearch();">
								</td>
