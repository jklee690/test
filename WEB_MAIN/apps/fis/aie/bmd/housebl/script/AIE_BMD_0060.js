	...
	try {
		switch(srcName) {
		    ...
		    break;
           	...
           	break;
	   	 	case "S_DOC":
		   	 	if (sheetObj3 == undefined || sheetObj3 == 'undefined') {
...
function setSearchNo(){
	...
	}else if(formObj.f_search_no_tp.value == "PO"){
		formObj.f_lc_no.value="";
		formObj.f_po_no.value=formObj.f_search_no.value;
		formObj.f_inv_no.value="";
		formObj.f_lnr_bkg_no.value="";
		formObj.f_exp_ref_no.value="";
...
function doDisplay(doWhat, formObj){
    switch(doWhat){
        ...
        case 'DATE2':   //달력 조회 팝업 호출      
             ...
             cal.select(formObj.s_bkg_dt_tm, 'yyyy-MM-dd');
        break;
