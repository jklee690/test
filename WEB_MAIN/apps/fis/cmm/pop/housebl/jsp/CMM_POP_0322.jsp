...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/cmm/pop/housebl/script/CMM_POP_0322.js"></script>
		        ...
		        <table>
			        ...
			        <tbody>
							<tr>
			                     ...
			                     <th>Trucking Co.</th>
			                         <td>
										<input type="text"   name="trsp_trdp_cd" id="trsp_trdp_cd" value='<bean:write name="hmOutParam" property="trsp_trdp_cd"/>' class="search_form" style="width:60px;"  onKeyDown="codeNameAction('partner_trucker',this, 'onKeyDown')" onBlur="codeNameAction('partner_trucker',this, 'onBlur')"><!-- 
			                             ...
			                             --><input type="text"   name="trsp_trdp_nm" id="trsp_trdp_nm" class="search_form" style="width:234px;" value=''><!-- 
			                 ...
			                 <tr>
			                     <th><bean:message key="Additional_Remark"/></th>
			                     <td>
