            ...
            with (sheetObj) {
				...
				if(formObj.air_sea_clss_cd.value== "S"){
					...
					cols = [ {Type:"Seq",     Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"no",               KeyField:0 },
			             {Type:"Text",     Hidden:0,  Width:100,  Align:"Left",    ColMerge:0,   SaveName:"master_bl_no",     KeyField:0 },
			             {Type:"Text",     Hidden:0,  Width:100,  Align:"Left",    ColMerge:0,   SaveName:"ref_no",           KeyField:0 }];
					
					if(formObj.bnd_clss_cd.value== "O"){
						cols.push({Type:"Text",      Hidden:0, Width:100,  Align:"Left",    ColMerge:0,   SaveName:"lnr_bkg_no",       KeyField:0 });
					}else{
					...
					cols.push({Type:"Text",     Hidden:0,  Width:70,   Align:"Left",    ColMerge:0,   SaveName:"pol_nm",           KeyField:0 });
					...
					cols.push({Type:"Text",     Hidden:0,  Width:70,   Align:"Left",    ColMerge:0,   SaveName:"pod_nm",           KeyField:0 });

					if(formObj.bnd_clss_cd.value== "O"){
					   cols.push({Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"obrd_dt_tm",       KeyField:0,   CalcLogic:"",   Format:"Ymd" });
	                   cols.push({Type:"Date",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"etd_dt_tm",        KeyField:0,   CalcLogic:"",   Format:"Ymd" });
	                   cols.push({Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"eta_dt_tm",        KeyField:0,   CalcLogic:"",   Format:"Ymd" });
                   }else{
	                   cols.push({Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"obrd_dt_tm",       KeyField:0,   CalcLogic:"",   Format:"Ymd" });
	                   cols.push({Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"etd_dt_tm",        KeyField:0,   CalcLogic:"",   Format:"Ymd" });
	                   cols.push({Type:"Date",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"eta_dt_tm",        KeyField:0,   CalcLogic:"",   Format:"Ymd" });
                   }
