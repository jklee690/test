...
function getCode(obj, isCstm){
	if(isCstm){
		if(frm1.disp_flt_no.value!=''){
	   		rtnary=new Array(1);
	   		rtnary[0]="2";
	   		var rtnVal =  ComOpenWindow('./EDI_CSTM_0011.clt',  rtnary,  "scroll:yes;status:no;help:no;dialogWidth:540px;dialogHeight:350px" , true);
      ...
      SetSheetHeight(370);
		...
		case 2:      //House B/L Information
	      ...
	      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Left",    ColMerge:1,   SaveName:"ibflag" },
		             ...
		             {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"h_expyn" },
