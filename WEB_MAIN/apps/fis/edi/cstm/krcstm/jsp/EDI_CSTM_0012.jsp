...
<%-- 	<bean:define id="mapObj" name="EventResponse" property="mapVal" value=""/> --%>
    ...
    <script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/edi/cstm/krcstm/script/EDI_CSTM_0012.js"></script>
...
<form name="frm1" method="POST" action="./EDI_CSTM_0012.clt">
    ...
    <input type="hidden" name="f_cstm_cd" value="" id="f_cstm_cd" />
    <input type="hidden" name="f_cstm_seq" id="f_cstm_seq" value=""> 
	...
	<div class="page_title_area clear">
			...
			--><button type="button" class="btn_normal" id="btnClose" id="btnClose"   onclick="window.close();"><bean:message key="Close"/></button> 
			</div>
			<!-- opus_design_btn(E) -->
	</div>
    <!-- page_title_area(E) -->	
