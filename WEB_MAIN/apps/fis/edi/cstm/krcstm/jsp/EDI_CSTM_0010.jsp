...
<%@ page import="java.util.HashMap"%>
    ...
    <script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/edi/cstm/krcstm/script/EDI_CSTM_0010.js"></script>
    ...
    <script type="text/javascript">
		...
		<logic:notEmpty name="EventResponse" property="mapVal">
			...
			<logic:notEmpty name="mapObj" property="cstm_cd">
				<bean:define id="cstmObj" name="mapObj" property="cstm_cd" value="" />
				...
				<logic:notEmpty name="mapObj" property="cstm_dpt_cd">	
					<bean:define id="cstmDptObj" name="mapObj" property="cstm_dpt_cd" value=""/>
...
<form name="frm1" method="POST" action="./">
	...
	<div class="wrap_result">
		<div class="opus_design_grid" id="mainTable">
			<div class="opus_design_btn">
				<button class="btn_normal" type="button" onclick="doWork('COMMAND01')" id="btn1" style="display:none;">전송자료 생성</button>
