...
<%@ page import="java.util.HashMap"%>
    ...
    <script language="javascript" src="<%=CLT_PATH%>/apps/fis/edi/cstm/krcstm/script/EDI_CSTM_0060.js"></script>
...
<form name="frm1" method="POST" action="./">
	...
	<div class="wrap_result">
    	...
    	<div class="opus_design_inquiry wFit">
			...
			<div class="opus_design_btn">
			   <span id="btn1" style="display:none;"><button type="button" class="btn_normal" onclick="doWork('COMMAND01')">전송자료 생성</button></span>
    			...
    			<colgroup>
    				...
    				<tbody>
                      <tr>
                          ...
                          <td>
							<span id="ediView" style="display:none;"><!--
		                ...
		                --><input type="hidden" name="disp_edi_msg_no" style="width:120" class="search_form-disable" readonly>
							</span>		
                          </td> 
                          <th>상태</th>
                          <td>
                      ...
                      <tr>
                          ...
                          <th>세관</th>
                          <td colspan="3"><!--
		                --><input type="text" name="disp_cstm_cd" style="width:50"  class="search_form" maxlength="3"  onKeyDown="if(window.event.keyCode==13){codeNameAction('OFC_CD',this, 'onKeyDown');}" onblur="codeNameAction('OFC_CD',this, 'onBlur')"><!--
		                --><button type="button" class="input_seach_btn" tabindex="-1"  onclick="getCode(this, true);"></button><!--
		                --><input type="text" name="disp_cstm_nm" style="width:100" class="search_form-disable" readonly>
                          </td>
                      </tr>
					  <tr>
                          <th>항차</th>
                          <td>
                              <input type="text" name="disp_flt_no" style="width:120" class="search_form-disable" readonly>
                          </td>
                          <th>세관부서</th>
                          <td colspan="3"><!--
		                --><input type="text" name="disp_cstm_dept_cd" style="width:50"  class="search_form"  maxlength="3" onKeyDown="if(window.event.keyCode==13){codeNameAction('SUB_OFC_CD',this, 'onKeyDown');}" onblur="codeNameAction('SUB_OFC_CD',this, 'onBlur')"><!--
		                --><button type="button" class="input_seach_btn" tabindex="-1"  onclick="getCode(this, false);"></button><!--
		                --><input type="text" name="disp_cstm_dept_nm" style="width:100" class="search_form-disable" readonly>
                          </td>
                      </tr>
                      <tr>
                          <th>선사코드/선사</th>
                          <td><!--
		                --><input type="text" name="disp_lnr_cstm_cd"  style="width:50"  class="search_form" maxlength="4">/ <!--
		                --><input type="text" name="disp_lnr_nm"       style="width:100" class="search_form-disable" readonly>
                          </td>
                          <th><bean:message key="MRN"/></th>
                          <td>
                              <input type="text" name="disp_mrn" style="width:90"  class="search_form-disable"  maxlength="20" readonly>
                          </td>
                     </tr>
				</tbody>
            </table>
